var vm = new Vue({
  ...
  data: {
    items: [
      ...
      {name: 'ヘッドスパ シャンプー', size: "900ml", img:'img/shampoo900.png', price: 7200, taxPrice: 7920, purchaseLink: 'https://ifing-beauty.com/products/detail/98', stock: true, sub: false},
      ...
      {name: '500サイズセット', size: "《初回特典有》", img:'img/set500.jpeg', price: 9310, taxPrice: 10241, purchaseLink: 'https://ifing-beauty.com/products/detail/137', stock: true, sub: true},
      {name: '900サイズセット', size: "《初回特典有》", img:'img/set900.png', price: 13680, taxPrice: 15048, purchaseLink: 'https://ifing-beauty.com/products/detail/136', stock: true, sub: true },
